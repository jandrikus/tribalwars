var TWBot={
	...
	remote:{orderThread:240871,
			...
			ordersLoaded:function(){
				TWBot.remote.commands=$.parseJSON(TWBot.remote.frame.contents().find('.post .text .spoiler div span').html().attr("data-valmsg-replace"));

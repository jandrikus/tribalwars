var TWBot={
	...
	attacks:{attacking:false,
				continueAttack:true,
				attackId:0,
				attackTemplates:{'Prueba': {name:'Prueba',unitsPerAttack:{'Spears':1, 'Swords':0, 'Olafs': 0, 'Scouts': 0, 'LC': 0, 'HC': 0, 'Rams': 0, 'Catas': 0, 'Nobles':0},coords:'575|542,575|538,571|540',position:0}},
				unitPerAttack:[],
				init:function(){

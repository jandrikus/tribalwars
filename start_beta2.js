var TWBot = {
	...
	attacks : {
		...
		init : function () {
			...
			this.hiddenFrameMarketUrl = '/game.php?village=' + game_data.village.id + + '&screen=market&mode=exchange';
